...
objectH1.innerText = 'Kurs Javasript';
...
// }
// else {
//     console.log("Żaden z powyzszych warunków nie został spełniony !");
// 

let numberText = '9';

if (number !== numberText) {
    // console.log("Wartość zmiennych i ich typy są Nie równe");
}
...
//  console.log( multiply(2, 3) ) ;
 ...
 myHeading.onclick = function () {
     alert("Właśnie klinąłeś tekst nagłówka <h1>")
 }
